...
### Encontrar % Participacion por Centro de Votacion ###

participacion_centro <- 
  group_by(resultados, centro, jrv) %>%
  summarise(carga_centro = mean(carga), votantes = sum(marcasPres))
...
resultados$grupo <- ifelse (resultados$partido == "PARTIDO NACIONAL DE HONDURAS")
